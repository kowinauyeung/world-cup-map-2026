...
```
src/
  domain/      # pure TS: types, normalizeTournament, selectors. MUST NOT import React or MapLibre.
  data/        # imports + validates + normalises data.json ONCE; exports normalised matches.
  features/
